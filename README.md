...
## run_analysis.R - when executed does the following: 

- creates a data folder
- downloads the zip data file 
- unzip the file
- reads in test and training data
- combines all of the data into one data frame
- renames columns to be more readable
- lastly it groups the data by subject and activity type and performs the mean for each of the value columns
- saves the data from the last step to tidyData.txt
